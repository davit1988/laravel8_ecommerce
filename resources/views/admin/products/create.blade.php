        ...
        <div class="card-body">
            <form method="post" action="{{route('products.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="slug" type="text" name="slug" placeholder="Enter name"  value="{{old('slug')}}" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="originalPrice" type="text" name="original_price" placeholder="Enter original price"  value="{{old('original_price')}}" class="form-control">
                </div>

                <div class="form-group">
                    <label for="sellingPrice" class="col-form-label">Selling price <span class="text-danger">*</span></label>
                    <input id="sellingPrice" type="text" name="selling_price" placeholder="Enter selling price"  value="{{old('selling_price')}}" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name='trending' id='trending' value='1' checked> Yes
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="qty" type="number" name="qty" placeholder="Enter qty"  value="{{old('qty')}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="tax" type="number" name="tax" placeholder="Enter tax"  value="{{old('tax')}}" class="form-control">
                        </div>
                    </div>
                </div>
